...
function normalizeToolHttpPath(tool) {
  // The hosted Next.js template expands one route per Orchet tool name at
  // app/tools/<tool.name>/route.ts. Keep the published OpenAPI path aligned
  // with that generated route; vendor/native paths belong inside the route
  // implementation, not in the Orchet-facing tool surface.
